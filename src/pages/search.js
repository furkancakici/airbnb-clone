...
const Search = ({ searchResult }) => {
    ...
    return (
        <>
            <Head>
                <title>Search / Airbnb Clone - Nextjs</title>
            ...
            <main className='flex max-w-7xl mx-auto px-8 sm:px-16 my-6'>
                <section>
                    ...
                    <div className='flex flex-col'>
                        {searchResult.map(({ description, img, location, price, star, title, total }) => (
                            <InfoCard key={img} description={description} img={img} location={location} price={price} star={star} title={title} total={total} />
                        ))}
                    </div>
                </section>
            </main>
